...
# fine tuned model
# curl -X POST localhost:5000/fine-tune-model -d '{"name":gitauto"}' -H "x-token: eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpYXQiOjE3MzAyMTE4NDIsImV4cCI6MTczMjgwMzg0Mn0.q56wPLwilzrU2efdixRQF-OqB2QOarPd82LUlQwxkSE"
